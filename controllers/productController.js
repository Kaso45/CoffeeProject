...
exports.getDetails = async (req, res) => {
  try {
    ...
    if (product) {
      res.render('layouts/products/product-details.ejs', {
        products: product,
        formatCurrency,
        generateStarRating,
      });
...
exports.getBeans = async (req, res) => {
  try {
    ...
    res.render('layouts/products/beans/beans', {
      products,
      formatCurrency,
      generateStarRating,
    });
...
exports.getGrounds = async (req, res) => {
  try {
    ...
    res.render('layouts/products/grounds/grounds', {
      products,
      formatCurrency,
      generateStarRating,
    });
...
exports.getCapsules = async (req, res) => {
  try {
    ...
    res.render('layouts/products/capsules/capsules', {
      products,
      formatCurrency,
      generateStarRating,
    });
